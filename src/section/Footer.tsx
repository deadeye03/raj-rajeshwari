...
export default async function Footer() {
    ...
    return (
        <footer className="bg-[#dcb187] relative">
                ...
                <div className="text-center mb-12">
                    ...
                    <div className="max-w-md mx-auto">
                        <div className="flex gap-2 justify-center items-center">
                            <Button className="bg-amber-500 hover:bg-white text-white hover:text-black">
                                Sign Up
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="md:col-span-1">
                        <FooterSection title="Explore" defaultOpen={true}>
                            <div className="flex flex-col space-y-3" key={Math.random()}>
                                {footerData.expolore?.map((item) => (
                                    <Link href={item.slug} key={item.slug} className="text-gray-500 hover:text-white">
                                        {item.title}
                                    </Link>
                        ...
                        <FooterSection title="Connect with us">
                            <div className="flex flex-col space-y-3">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <a href="mailto:contact@example.com" className="text-gray-500 hover:text-white">
                                        contact@example.com
                                    </a>
                                </div>
                                <p className="text-gray-500">
                                    123 Raj Rajeshwari Way
                                    <br />
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="text-sm text-gray-500">
                            &copy; {new Date().getFullYear()} Raj Rajeshwari Collective. All rights reserved.
                        </div>
                    </div>
                </div>
            </div>
